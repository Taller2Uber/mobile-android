...
//    public static final String BASE_URL = "http://172.20.10.4/api/v1/";
    ...
    public static final String PASSENGER = "passengers/{passenger}";
    public static final String DRIVER = "drivers/{driver}";
    ...
    public static final String REQUEST_ROUTE = "routes/request/{route}";
    public static final String PASSENGER_CONFIRM_ROUTE_REQUEST = "routes/answerRequest/{route}";
    public static final String DRIVER_START_ROUTE = "routes/start/{route}";
    public static final String DRIVER_FINISH_ROUTE = "routes/finish/{route}";
